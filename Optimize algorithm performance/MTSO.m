%% MTSO   An ultra©\short©\term wind speed prediction model using LSTM based on modified tuna swarm optimization and successive variational mode decomposition

function [Tuna1_fit,Tuna1,Convergence_curve]=MTSO(Particles_no,Max_iter,Low,Up,Dim,fobj)

Tuna1=zeros(1,Dim);   Tuna1_fit=inf;
pop=initializationNew_tent(Particles_no,Dim,Up,Low);
Iter=0;
z=0.05;
while Iter<Max_iter   
    aa=1-Iter/Max_iter;
